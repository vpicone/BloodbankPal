        ...
        <h3 style={textStyle}>
          ...
          <span>
            <RaisedButton
              ...
              icon={<EmailIcon />}
              href={
                "mailto:vppicone@ascension.org?subject=Medspeed%20Route%20Issue&body=Hospital:%0ATime:%0A"
              }
            />
          </span>
        </h3>
        ...
        <h3 style={textStyle}>
          ...
          <span>
            <RaisedButton
              ...
              labelColor={white}
              backgroundColor={
                props.showEntireSchedule ? deepOrange900 : cyan800
              }
              // primary='true'
